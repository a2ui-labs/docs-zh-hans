...
在 [`rizzcharts`](../../samples/agent/adk/rizzcharts/python/README.md) 示例中，catalog schema 定义在 [`rizzcharts_catalog_definition.json`](../../samples/agent/adk/rizzcharts/catalog_schemas/0.9/rizzcharts_catalog_definition.json)。
...
在 [`rizzcharts`](../../samples/client/angular/projects/rizzcharts/README.md) 示例中，`Chart` 组件定义在 [`chart.ts`](../../samples/client/angular/projects/rizzcharts/src/a2ui-catalog/chart.ts)。
...
在 [`rizzcharts`](../../samples/agent/adk/rizzcharts/python/README.md) 示例中，这在 [`catalog.ts`](../../samples/client/angular/projects/rizzcharts/src/a2ui-catalog/catalog.ts) 中完成。
...
Agent 使用 [SendA2uiToClientToolset](../../agent_sdks/python/src/a2ui/adk/send_a2ui_to_client_toolset.py) 获得一个可用于向客户端发送 A2UI 的工具。
...
LLM 对 [SendA2uiToClientToolset](../../agent_sdks/python/src/a2ui/adk/send_a2ui_to_client_toolset.py) 中工具的调用，会在 A2A Agent Executor 中通过 [A2uiEventConverter](../../agent_sdks/python/src/a2ui/adk/send_a2ui_to_client_toolset.py) 被拦截。这会自动把工具调用转换为带有 A2UI payload 的 A2A DataPart。
