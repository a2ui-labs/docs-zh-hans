...
所有 Web 渲染器（Lit、Angular、React）都共享一个共同基础：**`@a2ui/web-lib`**。这个库提供消息处理器、状态管理和数据绑定逻辑，是每个 Web 渲染器都需要的。各框架专属的渲染器都建立在它之上，只额外添加各自框架的渲染层。
...
**查看可运行示例：** [Lit shell sample](https://github.com/google/a2ui/tree/main/samples/client/lit/shell)

## Angular

> ⚠️ **注意**
>
> Angular 客户端库尚未发布到 NPM。请过几天再查看。
...
**查看可运行示例：** [Angular v0.9 Explorer](https://github.com/google/a2ui/tree/main/renderers/angular/a2ui_explorer)
...
**查看可运行示例：** [React shell](https://github.com/google/A2UI/tree/main/samples/client/react/shell)
