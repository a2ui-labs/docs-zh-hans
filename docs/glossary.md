...
参见 [basic catalog](../specification/v0_10/catalogs/basic/catalog.json)。
...
- **Catalog Schema**：
    ...
    例如，参见 [basic catalog schema](../specification/v0_10/catalogs/basic/catalog.json)。
...
参见 [basic catalog 中的示例](../specification/v0_10/catalogs/basic/catalog.json#L18)。
...
参见 [actions 详细指南](concepts/actions.md)。
